...
local backend = {
    ...
    ---@type fun()
    keyboard_navigation_deselect = nil,
    ---@type fun(integer)
    keyboard_navigation_jump_to_cell = nil,
    ---@type fun()
    keyboard_navigation_tab_forward = nil,
    ---@type fun()
    keyboard_navigation_tab_backwards = nil,
    ---@type boolean
    keyboard_navigation_selection_has_changed = false
}

---Inserts a character into the state
---@param state table
---@param char string
function backend.typing_insert_character(state, char)
...
---@param state table
function backend.typing_truncate(state)
    state.text = ""
...
---@param state table
function backend.typing_backspace_character(state)
